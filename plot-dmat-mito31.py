...
def plot_composite_matrix(D, labeltext, show_labels=True, show_indices=True,
    ...
    Z1 = sch.dendrogram(Y, orientation='left', labels=dendrolabels,
                        no_labels=not show_indices, leaf_font_size = 4)
    ax1.set_xticks([])
...
basefile = "yogesh_mito31" ##.labels.txt
D, labo = load_matrix_and_labels(basefile)

import matplotlib.pyplot as plt


print (labo)
plot_composite_matrix(D, labo)
plt.savefig("/Users/cheemaj/JITU/WORK/YOGESH/mito-sour-k31.svg")
